...
\restrict 9SILTnMGIytanxWkbMuj7iWzBZiAKffHS4sfQtXpxeznQYyH0VJNj1upXzaUuK1
...
3	3	Civil	CIVIL	now it is activated	t	2026-06-05 06:23:18.97	2026-08-01 10:59:05.067
...
SELECT pg_catalog.setval('maintix."AuditLog_id_seq"', 1253, true);
...
SELECT pg_catalog.setval('maintix."EquipmentType_id_seq"', 29, true);
...
SELECT pg_catalog.setval('maintix."UserSession_id_seq"', 1913, true);
...
\unrestrict 9SILTnMGIytanxWkbMuj7iWzBZiAKffHS4sfQtXpxeznQYyH0VJNj1upXzaUuK1
