...
\restrict YSraea58aVe8GiteGbVvDbAp7e6ULHvt5dLsLgQNNdXihH2TyQCubbJE8Jp5WzI
...
SELECT pg_catalog.setval('maintix."AuditLog_id_seq"', 1377, true);
...
SELECT pg_catalog.setval('maintix."ChecklistItem_id_seq"', 130, true);
...
SELECT pg_catalog.setval('maintix."ChecklistTemplate_id_seq"', 59, true);
...
SELECT pg_catalog.setval('maintix."UserSession_id_seq"', 2865, true);
...
\unrestrict YSraea58aVe8GiteGbVvDbAp7e6ULHvt5dLsLgQNNdXihH2TyQCubbJE8Jp5WzI
